namespace PharmacyService.Application.Features.PharmacyBranch.Constants;

public static class PharmacyBranchConstants
{
    private const string Prefix = "PharmacyBranch";
